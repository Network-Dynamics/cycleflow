...
\dirk{XXX Left: Flow strength in color code
for a map of the lattice as in the paper by Kettemann et al. Right: Magnitude $|f_c|$ versus
distance without, with small and with strong randomness. Make a statement if the numerical 
...
\begin{figure}
    ...
    \includegraphics[width=.9\columnwidth]{pics/decay_log_log_sqgrid}}
    \caption{(a) Decay of induced cycle flows in a square lattice of size 200x200 after the 
	    failure of the edge edge between nodes (0,0) and (0,1). (b) The 
	    log-log plot of the same showing power law decay}
	    \label{fig:decay-sqgrid}
\end{figure}
